...
| package                                  | import                                   | description                              |
| ---------------------------------------- | ---------------------------------------- | ---------------------------------------- |
| [rawproto](https://github.com/henrylee2cn/teleport/tree/master/proto/rawproto) | `"github.com/henrylee2cn/tp/v6/proto/rawproto` | A fast socket communication protocol(teleport default protocol) |
| [jsonproto](https://github.com/henrylee2cn/teleport/tree/master/proto/jsonproto) | `"github.com/henrylee2cn/tp/v6/proto/jsonproto"` | A JSON socket communication protocol     |
| [pbproto](https://github.com/henrylee2cn/teleport/tree/master/proto/pbproto) | `"github.com/henrylee2cn/tp/v6/proto/pbproto"` | A Protobuf socket communication protocol     |
| [thriftproto](https://github.com/henrylee2cn/teleport/tree/master/proto/thriftproto) | `"github.com/henrylee2cn/tp/v6/proto/thriftproto"` | A Thrift communication protocol     |
| [httproto](https://github.com/henrylee2cn/teleport/tree/master/proto/httproto) | `"github.com/henrylee2cn/tp/v6/proto/httproto"` | A HTTP style socket communication protocol     |
