...
func (*Format) Descriptor() ([]byte, []int) {
	return fileDescriptor_format_c385c8de80b5a791, []int{0}
}
...
func (m *Format) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Mtype != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintFormat(dAtA, i, uint64(m.Mtype))
	}
	if len(m.Uri) > 0 {
		dAtA[i] = 0x1a
		i++
...
func init() { proto.RegisterFile("format.proto", fileDescriptor_format_c385c8de80b5a791) }

var fileDescriptor_format_c385c8de80b5a791 = []byte{
	...
	0x0c, 0x02, 0x31, 0x85, 0x44, 0xb8, 0x58, 0x73, 0x4b, 0x2a, 0x0b, 0x52, 0x25, 0x98, 0x14, 0x18,
	...
	0x12, 0xec, 0x60, 0x09, 0x0e, 0x90, 0x40, 0x40, 0x66, 0x41, 0xaa, 0x93, 0xc4, 0x89, 0x47, 0x72,
	0x8c, 0x17, 0x1e, 0xc9, 0x31, 0x3e, 0x78, 0x24, 0xc7, 0x38, 0xe1, 0xb1, 0x1c, 0xc3, 0x85, 0xc7,
	0x72, 0x0c, 0x37, 0x1e, 0xcb, 0x31, 0x24, 0xb1, 0x81, 0x7d, 0x63, 0x0c, 0x08, 0x00, 0x00, 0xff,
	0xff, 0x66, 0xb8, 0xe4, 0x0e, 0xdd, 0x00, 0x00, 0x00,
}
